function [perm_p_pos, perm_p_neg, perm_p_combined] = CPM_permutation_test_parallelised(all_behav, ...
    all_mats, all_covars, k, thresh_type, thresh, adjust_stage, true_r_pos,...
...
% Permute CPM %% ADD PARFOR LOOP HERE
parfor i = 1:perm_iterations
    ...
    [behav_pred_pos, behav_pred_neg, behav_pred_combined,...
        ~, ~, ~, ~, ~, ~, ~] = run_flexible_CPM(...
        random_behav, all_mats, all_covars, k, thresh_type, ...
        thresh, adjust_stage);
